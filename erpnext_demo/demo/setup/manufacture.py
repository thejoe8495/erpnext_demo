...
from erpnext_demo.demo.domains import data
from erpnext_demo.demo.setup.setup_data import import_json
...
def setup_asset():
	...
	for d in assets:
		...
		asset.make_depreciation_schedule(add_days(nowdate(), -random.randint(20, 100)))
