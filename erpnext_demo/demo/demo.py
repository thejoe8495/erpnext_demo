...
import erpnext
from erpnext_demo.demo.setup import education, healthcare, manufacture, retail, setup_data
from erpnext_demo.demo.user import accounts
from erpnext_demo.demo.user import education as edu
from erpnext_demo.demo.user import fixed_asset, hr, manufacturing, projects, purchase, sales, stock
